 ...
 * 
 * @param  b      : AllocBlock object
 * @return size_t : Available memory (bytes)
 */
 ...
 * 
 * @param  b      : AllocBlock object
 * @return size_t : Size of actual memory block (bytes)
 */
 ...
 * 
 * @param  b      : AllocBlock object
 * @return size_t : Allocation strategy
 */
 ...
 * 
 * @param  b      : AllocBlock object
 * @return size_t : Used memory (bytes)
 */
 ...
 * @param  itemSize : Size of an single item (bytes)
 * @return void*    : Pointer to item at given index
 */
 ...
 * @return AllocBlock* : AllocBlock object
 */
 ...
 * 
 * @param b    : AllocBlock object
 * @param size : New size (bytes). This is the required size, but actual size 
 * could be larger depending on allocation strategy
 */
